...
class _MyTeamsPageState extends State<MyTeamsPage> {
  ...
  Widget _buildError(TeamViewModel viewModel) {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          const SizedBox(height: 12),
          Text(viewModel.errorMy, textAlign: TextAlign.center),
          const SizedBox(height: 12),
          ElevatedButton.icon(
            onPressed: viewModel.fetchMyTeams,
